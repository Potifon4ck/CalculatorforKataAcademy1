...
class Calculator {
    ...
    public static void main (String[] args) {
        System.out.println("Введите два числа (Римские или Арабские цифры на одной строке) ");
    ...
    private static int romanToNumber (String roman) {
        try {
            ...
            throw new InputMismatchException("Ошибка, не верные данные");
        }
        return -1;
    }
        ...
        switch (op) {
            ...
            case '/':
                try {
                    ...
                    System.out.println("Правильный формат : " + e);
                    break;
                }
                break;
            default:
                throw new IllegalArgumentException("Неправильный знак");
        }
        return result;
    }
}